...
public class AgawanBaseGamePlay extends JPanel implements Runnable, AgawanBaseConstants{
	...
	//constructor
	public AgawanBaseGamePlay(String server,String name) throws Exception{
		this.server=server;
		this.name=name;
